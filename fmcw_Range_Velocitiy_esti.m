...
parfor indexM = 1:nTest
    ...
    %proposed
    % 초기화 변수
    Result1_1_r = []; Result1_2_r = []; Result1_3_r = []; Result1_4_r = [];
    ...
    Result2_1_r=length(find(Result2_r == 1)); 
    Result2_2_r=length(find(Result2_r == 2));
    Result2_3_r=length(find(Result2_r == 3));
    Result2_4_r=length(find(Result2_r == 4));
    num1_probab_l_r=Result2_1_r/length(Result2_r);
    num2_probab_l_r=Result2_2_r/length(Result2_r);
    num3_probab_l_r=Result2_3_r/length(Result2_r);
    num4_probab_l_r=Result2_4_r/length(Result2_r);

    Result3_1_r=length(find(Result3_r == 1)); 
    Result3_2_r=length(find(Result3_r == 2));
    Result3_3_r=length(find(Result3_r == 3));
    Result3_4_r=length(find(Result3_r == 4));
    num1_probab_f_r=Result3_1_r/length(Result3_r);
    num2_probab_f_r=Result3_2_r/length(Result3_r);
    num3_probab_f_r=Result3_3_r/length(Result3_r);
    num4_probab_f_r=Result3_4_r/length(Result3_r);
    ...
    Result2_1_c=length(find(Result2_c == 1)); 
    Result2_2_c=length(find(Result2_c == 2));
    Result2_3_c=length(find(Result2_c == 3));
    Result2_4_c=length(find(Result2_c == 4));
    num1_probab_l_c=Result2_1_c/length(Result2_c);
    num2_probab_l_c=Result2_2_c/length(Result2_c);
    num3_probab_l_c=Result2_3_c/length(Result2_c);
    num4_probab_l_c=Result2_4_c/length(Result2_c);

    Result3_1_c=length(find(Result3_c == 1)); 
    Result3_2_c=length(find(Result3_c == 2));
    Result3_3_c=length(find(Result3_c == 3));
    Result3_4_c=length(find(Result3_c == 4));
    num1_probab_f_c=Result3_1_c/length(Result3_c);
    num2_probab_f_c=Result3_2_c/length(Result3_c);
    num3_probab_f_c=Result3_3_c/length(Result3_c);
    num4_probab_f_c=Result3_4_c/length(Result3_c);
    ...
    if num_C > num_T
        ...
        Result2_1_d=length(find(Result2_d == 1)); 
        Result2_2_d=length(find(Result2_d == 2));
        Result2_3_d=length(find(Result2_d == 3));
        Result2_4_d=length(find(Result2_d == 4));
        num1_probab_l_d=Result2_1_d/length(Result2_d);
        num2_probab_l_d=Result2_2_d/length(Result2_d);
        num3_probab_l_d=Result2_3_d/length(Result2_d);
        num4_probab_l_d=Result2_4_d/length(Result2_d);

        Result3_1_d=length(find(Result3_d == 1)); 
        Result3_2_d=length(find(Result3_d == 2));
        Result3_3_d=length(find(Result3_d == 3));
        Result3_4_d=length(find(Result3_d == 4));
        num1_probab_f_d=Result3_1_d/length(Result3_d);
        num2_probab_f_d=Result3_2_d/length(Result3_d);
        num3_probab_f_d=Result3_3_d/length(Result3_d);
        num4_probab_f_d=Result3_4_d/length(Result3_d);
        ...
        Result2_1_a=length(find(Result2_a == 1)); 
        Result2_2_a=length(find(Result2_a == 2));
        Result2_3_a=length(find(Result2_a == 3));
        Result2_4_a=length(find(Result2_a == 4));
        num1_probab_l_a=Result2_1_a/length(Result2_a);
        num2_probab_l_a=Result2_2_a/length(Result2_a);
        num3_probab_l_a=Result2_3_a/length(Result2_a);
        num4_probab_l_a=Result2_4_a/length(Result2_a);

        Result3_1_a=length(find(Result3_a == 1)); 
        Result3_2_a=length(find(Result3_a == 2));
        Result3_3_a=length(find(Result3_a == 3));
        Result3_4_a=length(find(Result3_a == 4));
        num1_probab_f_a=Result3_1_a/length(Result3_a);
        num2_probab_f_a=Result3_2_a/length(Result3_a);
        num3_probab_f_a=Result3_3_a/length(Result3_a);
        num4_probab_f_a=Result3_4_a/length(Result3_a);
    ...
    R_performance(indexM,indexSNR)=sqrt(mse(sort(R),sort(R_ESTIMATION)));
    V_performance(indexM,indexSNR)=sqrt(mse(sort(V),sort(V_ESTIMATION)));
    ...
    R_performance_legacy(indexM,indexSNR)=sqrt(mse(sort(R),sort(R_ESTIMATION_legacy)));
    V_performance_legacy(indexM,indexSNR)=sqrt(mse(sort(V),sort(V_ESTIMATION_legacy)));
    ...
    R_performance_fft(indexM,indexSNR)=sqrt(mse(sort(R),sort(R_ESTIMATION_fft)));
    V_performance_fft(indexM,indexSNR)=sqrt(mse(sort(V),sort(V_ESTIMATION_fft)));
    ...
    R_performance_cfar(indexM,indexSNR)=sqrt(mse(sort(R),sort(esti_range_cfar_f)));
    V_performance_cfar(indexM,indexSNR)=sqrt(mse(sort(V),sort(esti_vel_cfar_f)));
...
R_performance_final(indexSNR)=mean(R_performance(:,indexSNR))
R_performance_legacy_final(indexSNR)=mean(R_performance_legacy(:,indexSNR))
R_performance_fft_final(indexSNR)=mean(R_performance_fft(:,indexSNR))
R_performance_cfar_final(indexSNR)=mean(R_performance_cfar(:,indexSNR))

V_performance_final(indexSNR)=mean(V_performance(:,indexSNR))
V_performance_legacy_final(indexSNR)=mean(V_performance_legacy(:,indexSNR))
V_performance_fft_final(indexSNR)=mean(V_performance_fft(:,indexSNR))
V_performance_cfar_final(indexSNR)=mean(V_performance_cfar(:,indexSNR))


detectionRate1(indexSNR) = sum(sum(test_result1_mat .* testAns)) / nTest
detectionRate2(indexSNR) = sum(sum(test_result2_mat .* testAns)) / nTest
detectionRate3(indexSNR) = sum(sum(test_result3_mat .* testAns)) / nTest
detectionRate4(indexSNR) = sum(sum(test_result4_mat_cfar.*testAns))/nTest
...
%% figure part
figure(1)
plot(trainSNRset, R_performance_final,'ro-','LineWidth',1); hold on
plot(trainSNRset, R_performance_legacy_final,'b^-.','LineWidth',1); hold on
plot(trainSNRset, R_performance_fft_final,'gdiamond:','LineWidth',1); hold on
plot(trainSNRset,R_performance_cfar_final,'k--+','Linewidth',1); hold on
grid on
xticks(trainSNRset)
xlabel('SNR [dB]')
...
figure(2)
plot(trainSNRset, V_performance_final, 'ro-','LineWidth',1); hold on
plot(trainSNRset, V_performance_legacy_final,'b^-.','LineWidth',1); hold on
plot(trainSNRset, V_performance_fft_final,'gdiamond:','LineWidth',1); hold on
plot(trainSNRset,V_performance_cfar_final,'k--+','Linewidth',1); hold on
grid on
xticks(trainSNRset)
xlabel('SNR [dB]')
...
figure(3)
semilogy(trainSNRset, R_performance_final./R_max, 'r-o','LineWidth',1); hold on
semilogy(trainSNRset, R_performance_legacy_final./R_max,'b-.^','Linewidth',1); hold on
semilogy(trainSNRset, R_performance_fft_final./R_max,'g:diamond','Linewidth',1); hold on
semilogy(trainSNRset,R_performance_cfar_final./R_max,'k--+','Linewidth',1); hold on
grid on
xticks(trainSNRset)
xlabel('SNR [dB]')
...
figure(4)
semilogy(trainSNRset, V_performance_final./V_max, 'ro-','LineWidth',1); hold on
semilogy(trainSNRset, V_performance_legacy_final./V_max,'b^-.','LineWidth',1); hold on
semilogy(trainSNRset, V_performance_fft_final./V_max,'gdiamond:','LineWidth',1); hold on
semilogy(trainSNRset,V_performance_cfar_final./V_max,'k--+','Linewidth',1); hold on
grid on
xticks(trainSNRset)
xlabel('SNR [dB]')
...
figure(5)
plot(trainSNRset,detectionRate1,'r-o','linewidth',1)
hold on
grid on
plot(trainSNRset,detectionRate2,'b-.^','linewidth',1)
plot(trainSNRset,detectionRate3,'g:d','linewidth',1)
plot(trainSNRset,detectionRate4,'k--+','linewidth',1)
xlabel("SNR [dB]")
